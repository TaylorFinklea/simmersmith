...
- Later: Phase 3 — app wiring (`AppState+Assistant` forwards incremental deltas) + on-device gate (HUMAN — not looped; the real streaming + open-models reasoning-replay proof).
