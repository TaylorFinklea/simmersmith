...
- [!] e0a P2h owner repair: build 165 proved clean exact-zone checkpoints but rejected false `zoneEnsured`; fix `a593e5f`, exact CI `30169322071` green. Build 166 is the next default-off proof vehicle; overrides remain ON.
...
## Blockers
- `simmersmith-rpz` P0: exact-zone contents and owner-zone proof fixes green; awaiting build-166 physical cached-resume proof.
