...
enum ReleaseNotesCatalog {
    ...
    static let all: [ReleaseNote] = [
        ReleaseNote(
            ...
            version: "1.0.0",
            date: "August 16, 2026",
            headline: "Recipe photos keep up",
            new: [],
            improved: [],
            fixed: [
                "You can replace a newly uploaded recipe photo again without restarting the app.",
            ]
        ),
        ReleaseNote(
            build: 176,
            version: "1.0.0",
            date: "August 14, 2026",
            headline: "Household changes stay reliable",
            new: [],
            improved: [],
            fixed: [
                "Meal plans and recipe photos now save reliably after syncing across devices.",
            ]
        ),
        ReleaseNote(
            build: 175,
        ...
        ReleaseNote(
            ...
            improved: [],
            fixed: [
                "Shared household edits are more reliable when you close the app immediately after making a change.",
            ]
        ),
        ReleaseNote(
            build: 173,
        ...
        ReleaseNote(
            ...
            version: "1.0.0",
            date: "July 19, 2026",
            headline: "A steadier grocery sync",
            new: [],
            improved: [],
            fixed: [
                "The app no longer closes unexpectedly while syncing grocery changes after you reconnect.",
            ]
        ),
        ReleaseNote(
            build: 161,
